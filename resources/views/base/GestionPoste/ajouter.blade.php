...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="h3"><i class="bi bi-briefcase me-2"></i> Ajouter un poste</h1>
            ...
            <form action="{{ route('postes.store') }}" method="POST">
                ...
                <div class="form-floating mb-3">
                    <input type="text" name="titre" id="titre"
                           ...
                           placeholder="Titre du poste" value="{{ old('titre') }}" required>
                ...
                <div class="form-floating mb-3">
                    <input type="number" step="0.01" min="0" name="salaire_base" id="salaire_base"
                           ...
                           placeholder="Salaire de base" value="{{ old('salaire_base') }}" required>
